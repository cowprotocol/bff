...
export interface PairVolatility extends Omit<VolatilityDetails, 'tokenAddress' | 'usdPrice' | 'volatilityInUsd'> {
  baseTokenAddress: string
  quoteTokenAddress: string
}
...
export interface SlippageService {
  ...
  getVolatilityDetails(chainId: SupportedChainId, tokenAddress: string): Promise<VolatilityDetails | null>
