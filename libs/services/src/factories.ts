...
export function getErc20Repository(cacheRepository: CacheRepository): Erc20Repository {
  ...
  return new Erc20RepositoryCache(fallback, cacheRepository, 'erc20', CACHE_TOKEN_INFO_SECONDS)
}
...
export function getUsdRepositoryCow(cacheRepository: CacheRepository, erc20Repository: Erc20Repository): UsdRepository {
...
export function getUsdRepositoryCoingecko(cacheRepository: CacheRepository): UsdRepository {
  return new UsdRepositoryCache(
...
export function getTokenHolderRepositoryMoralis(cacheRepository: CacheRepository): TokenHolderRepository {
  return new TokenHolderRepositoryCache(
...
export function getTokenHolderRepository(cacheRepository: CacheRepository): TokenHolderRepository {
