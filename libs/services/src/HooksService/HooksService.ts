...
const BLOCKCHAIN_VALUES = ['mainnet', 'arbitrum', 'avalanche', 'base', 'gnosis', 'polygon'] as const
const PERIOD_VALUES = ['last 3h', 'last 1d', 'last 7d', 'last 30d', 'last 3m', 'last 6m', 'last 12m'] as const
