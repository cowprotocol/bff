...
const requiredStringFields = ['environment', 'block_time', 'app_code', 'hook_type', 'target', 'app_hash', 'tx_hash']
...
export function isHookData(data: unknown): data is HookData {
  ...
  if (dataRecord.destination_chain_id !== null && typeof dataRecord.destination_chain_id !== 'number') {
    return false
  }
  if (dataRecord.destination_token_address !== null && typeof dataRecord.destination_token_address !== 'string') {
    return false
  }
