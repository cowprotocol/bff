...
export interface paths {
    ...
    "/api/v1/quote/stream": {
        ...
        put?: never;
        /**
         * Stream quotes from individual solvers as they arrive.
...
export interface operations {
    ...
    quoteStream: {
        ...
        responses: {
            /** @description A Server-Sent Events stream. Each event's `data` field is a JSON object matching `OrderQuoteResponse`. Events arrive one per quote as solvers respond.
             *      */
            200: {
                headers: {
                    [name: string]: unknown;
