...
export interface DuneRepository {
  getQueryResults<T>(params: GetQueryResultsParams<T>): Promise<DuneResultResponse<T>>

  executeQuery(params: ExecuteQueryParams): Promise<DuneExecutionResponse>

  getExecutionResults<T>(params: GetExecutionResultsParams): Promise<DuneResultResponse<T>>

  waitForExecution<T>(params: WaitForExecutionParams<T>): Promise<DuneResultResponse<T>>
