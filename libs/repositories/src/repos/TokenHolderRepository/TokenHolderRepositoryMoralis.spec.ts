...
describe.skip('TokenHolderRepositoryMoralis', () => {
  ...
  beforeAll(() => {
    ...
    container.bind<TokenHolderRepositoryMoralis>(TokenHolderRepositoryMoralis).to(TokenHolderRepositoryMoralis)
  ...
  describe('getTopTokenHolders', () => {
    it('should return the top token holders of WETH', async () => {
      const tokenHolders = await tokenHolderRepositoryMoralis.getTopTokenHolders(SupportedChainId.MAINNET, WETH)
    ...
    it('should return null for an unknown token', async () => {
      const tokenHolders = await tokenHolderRepositoryMoralis.getTopTokenHolders(SupportedChainId.MAINNET, NULL_ADDRESS)
