...
describe('TokenHolderRepositoryCoingecko', () => {
  describe('getTopTokenHolders', () => {
    it('Returns first repo price when is not null', async () => {
      ...
      let tokenHolders = await tokenHoldersRepositoryFallback.getTopTokenHolders(...PARAMS_PRICE)
      ...
      tokenHolders = await tokenHoldersRepositoryFallback.getTopTokenHolders(...PARAMS_PRICE)
    ...
    it('Returns second repo holders when null', async () => {
      ...
      const tokenHolders = await tokenHoldersRepositoryFallback.getTopTokenHolders(...PARAMS_PRICE)
      expect(tokenHolders).toStrictEqual(firstRepositoryResult)
    })
    ...
    it('Returns null when no repo return holders', async () => {
      ...
      const price = await tokenHoldersRepositoryFallback.getTopTokenHolders(...PARAMS_PRICE)
