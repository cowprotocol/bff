...
export interface ComposableCoWInterface extends utils.Interface {
  ...
  events: {
    "ConditionalOrderCreated(address,tuple)": EventFragment;
    "MerkleRootSet(address,bytes32,tuple)": EventFragment;
...
export interface ComposableCoW extends BaseContract {
  ...
  filters: {
    "ConditionalOrderCreated(address,tuple)"(
      owner?: string | null,
      params?: null
    ...
    "MerkleRootSet(address,bytes32,tuple)"(
      owner?: string | null,
      root?: null,
      proof?: null
